...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/euporie-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12756&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/euporie-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `euporie` can be installed with:

```
conda install euporie
```

It is possible to list all of the versions of `euporie` available on your platform with:
